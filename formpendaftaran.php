...
<div class="form-group row">
		...
		<div class="col-sm-10">
			...
			<input type="radio" name="cita" <?php if (isset($cita) && $cita=="tnipolri") echo "checked";?>  value="TNI/POLRI">B) TNI/POLRI
...
<div class="form-group row">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="radio" name="kps" <?php if (isset($kps) && $kps=="Iya") echo "checked";?> value="Iya">Iya 
			<input type="radio" name="kps" <?php if (isset($kps) && $kps=="Tidak") echo "checked";?> value="Tidak">Tidak<span class="warning"><?php echo $error_kps; ?></span> 
		</div>
	</div>		
...
<div class="form-group row">
	...
	<div class="form-group row">
		<div class="col-sm-10">
			...
			<a href="exportpdf.php">Export Ke PDF</a>
		</div>
	</div>
</form>
</div>
